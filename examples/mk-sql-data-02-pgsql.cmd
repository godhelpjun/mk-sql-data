...
database provider is "PGSQL";
connection parameters are "host=192.168.1.66 dbname=db2phpsite,db2phpsite,db2phpsite,db2phpsite";
...
filename is "output/random-fk-pgsql.sql";
